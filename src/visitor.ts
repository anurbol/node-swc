import {
    Module, ModuleItem, ModuleDeclaration, TsNamespaceExportDeclaration,
    TsExportAssignment, TsImportEqualsDeclaration, ExportAllDeclaration,
    ExportDefaultExpression, ExportNamedDeclaration, ExportSpecifier,
    NamedExportSpecifier, ExportNamespaceSpecifer, ExportDefaultSpecifier,
    StringLiteral, ExportDefaultDeclaration, ExportDeclaration, ArrayExpression,
    Expression, SpreadElement, ArrowFunctionExpression, BlockStatement, Statement,
    SwitchStatement, SwitchCase, IfStatement, BreakStatement, WhileStatement,
    TryStatement, CatchClause, ThrowStatement, ReturnStatement, LabeledStatement,
    ForStatement, ForOfStatement, ForInStatement, EmptyStatement, DoWhileStatement,
    DebuggerStatement, WithStatement, Declaration, VariableDeclaration,
    VariableDeclarator, TsTypeAliasDeclaration, TsModuleDeclaration,
    TsInterfaceDeclaration, TsEnumDeclaration, FunctionDeclaration,
    ClassDeclaration, ContinueStatement, TsTypeParameterDeclaration,
    TsTypeAnnotation, TsType, Pattern, ImportDeclaration, ImportSpecifier,
    NamedImportSpecifier, ImportNamespaceSpecifier, ImportDefaultSpecifier,
    Identifier, TsTypeParameterInstantiation, TsExpressionWithTypeArguments,
    TsEntityName, Decorator, ClassMember, TsIndexSignature, PrivateProperty,
    PrivateMethod, Constructor, ClassProperty, ClassMethod, Accessibility, PropertyName,
    NumericLiteral, TsParameterProperty, PrivateName, Fn, TsQualifiedName,
    TsParameterPropertyParameter, TsModuleReference, TsExternalModuleReference,
    AssignmentPattern, RestElement, ObjectPattern, ArrayPattern, DefaultDecl, Class,
    FunctionExpression, ClassExpression, TsFnParameter, TsTypeParameter, ObjectPatternProperty,
    TsNamespaceBody, TsModuleName, TsNamespaceDeclaration, TsModuleBlock, TsInterfaceBody,
    TsTypeElement, TsEnumMember, TsEnumMemberId, YieldExpression, UpdateExpression,
    UnaryExpression, TsTypeCastExpression, TsTypeAssertion, TsNonNullExpression,
    TsAsExpression, ThisExpression, TemplateLiteral, TaggedTemplateExpression,
    SequenceExpression, RegExpLiteral, ParenthesisExpression, ObjectExpression,
    NullLiteral, NewExpression, MetaProperty, MemberExpression, JSXText, JSXNamespacedName,
    JSXMemberExpression, JSXFragment, JSXEmptyExpression, JSXElement, ConditionalExpression,
    CallExpression, BooleanLiteral, BinaryExpression, AwaitExpression,
    KeyValuePatternProperty, AssignmentPatternProperty, Property, AssignmentExpression,
    Super, Span, JSXObject, JSXClosingFragment, JSXElementChild, JSXOpeningFragment,
    JSXClosingElement, JSXOpeningElement, JSXAttributeOrSpread, JSXExpressionContainer,
    JSXSpreadChild, JSXElementName, JSXAttribute, JSXAttributeName, SetterProperty,
    MethodProperty, KeyValueProperty, GetterProperty, AssignmentProperty
} from './ast';
...
export default class Visitor {
    ...
    visitArrayElement(e: Expression | SpreadElement | undefined): Expression | SpreadElement | undefined {
    ...
    visitTsNamespaceBody(
        n: TsNamespaceBody
    ): TsNamespaceBody | undefined {
        if (n) {
            switch (n.type) {
                case 'TsModuleBlock':
    ...
    visitTsParameterProperty(n: TsParameterProperty): TsParameterProperty | Pattern {
        n.accessibility = this.visitAccessibility(n.accessibility);
        n.decorators = this.visitDecorators(n.decorators);
    ...
    visitPropertyName(key: PropertyName): PropertyName {
        switch (key.type) {
            ...
            default:
                return this.visitExpression(key);
        }
    }
    ...
    visitNullLiteral(n: NullLiteral): Expression {
        return n
    }
    ...
    visitArguments(nodes: (SpreadElement | Expression)[]): (SpreadElement | Expression)[] {
    ...
    visitJSXExpressionContainer(n: JSXExpressionContainer): JSXElementChild {
        n.expression = this.visitExpression(n.expression);
        return n;
    }
    ...
    visitBooleanLiteral(n: BooleanLiteral): Expression {
        return n
    }
    ...
    visitNumericLiteral(n: NumericLiteral): Expression {
        return n
    }
